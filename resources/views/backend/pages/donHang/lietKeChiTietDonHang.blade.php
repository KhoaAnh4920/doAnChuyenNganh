            ...
            <div class="card mb-4">
                ...
                <div class="card-header d-flex flex-row align-items-center justify-content-between">
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">
                        NGÀY ĐẶT: {{$order_by_id->ngayDatHang}}
                    </h6>
                </div>
                <div class="p-3">
                    <table style="width:100%;" class="table align-items-center table-flush table-hover "
                        ...
                        <tr>
                            ...
                            <th class="m-0 font-weight-bold text-primary" style="text-align: center;">Trạng thái đơn
                                hàng</th>
                        </tr>
                        <br>
                        <tr>
                    ...
                    <form action="{{URL::to('/update-status-order')}}" method="post" role="form">
                        ...
                        <div class="form-group" data-select2-id="11" style="margin-top:20px">
                            <label for="select2SinglePlaceholder" class="m-0 font-weight-bold text-primary"
                                style="display: block;">Trạng thái đơn hàng</label>
                            <select class="select2-single-placeholder form-control select2-hidden-accessible"
                                ...
                                style="width: 15%; display: inline-table; margin-top:10px" aria-hidden="true"; >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="order_id" class="order_code"
